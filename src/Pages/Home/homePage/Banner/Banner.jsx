...
const Banner = () => {
  ...
  <div className="hero-content text-center text-neutral-content">
    <div className="max-w-md">
      <h1 className="mb-5 md:text-4xl text-3xl lg:text-5xl font-bold text-white">Welcome to <span className="bg-gradient-to-r from-cyan-200 via-cyan-600 to-cyan-200 text-transparent bg-clip-text">&#8707;nternPlaza!!</span></h1>
